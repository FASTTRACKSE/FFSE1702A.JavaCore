...
--
-- Host: localhost
-- Generation Time: May 02, 2018 at 04:14 PM
...
CREATE TABLE IF NOT EXISTS `BanDoc` (
  ...
  `Dia_Chi` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Thanh_Pho` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Quan` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `Phuong` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SDT` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `SachDangMuon` int(1) NOT NULL DEFAULT '0'
...
INSERT INTO `BanDoc` (`ID`, `HoTen`, `Dia_Chi`, `Thanh_Pho`, `Quan`, `Phuong`, `SDT`, `Email`, `SachDangMuon`) VALUES
(1, 'Nguyễn Văn A', 'Kiệt 5, Phố Hàng Gánh', 'Thành phố Hà Nội', 'Quận Ba Đình', 'Phường Phúc Xá', '0123567987', 'VanA@gmail.com', 0),
(2, 'Nguyễn Văn B', 'Số nhà 36, Đường U23', 'Tỉnh Hà Giang', 'Huyện Quang Bình', 'Xã Xuân Minh', '0945236845', 'VanB@gmail.com', 0),
(3, 'Nguyễn Văn C', '12 Quận 1', 'Thành phố Hồ Chí Minh', 'Quận 1', NULL, '0167523698', 'VanC@gamil.com', 0),
(4, 'Nguyễn Văn D', '12 Quận 1', 'Thành phố Đà Nẵng', 'Quận Sơn Trà', NULL, '0167523698', 'VanD@gamil.com', 0),
(5, 'Nguyễn Văn E', '20 Quận 4', 'Thành phố Hồ Chí Minh', 'Quận 1', NULL, '0165523698', 'VanE@gamil.com', 0),
(6, 'Trần A', 'Kiệt 3, số 18', 'Thành phố Đà Nẵng', 'Quận Sơn Trà', NULL, '0123789542', 'Tran@gamil.com', 0),
(7, 'Trần B', 'Kiệt 3, số 18', 'Tỉnh An Giang', 'Thị xã Tân Châu', NULL, '0123456789', 'TranB@gmail.com', 0),
(8, 'Trần Tùng', 'Số nhà 20, đường Văn Chiểu', 'Tỉnh Cà Mau', 'Huyện Đầm Dơi', NULL, '0123456789', 'Tung@gmail.com', 3);
...
CREATE TABLE IF NOT EXISTS `MuonTra` (
  ...
  `TenDG` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ID_DG` int(11) NOT NULL,
  `SDT` varchar(11) NOT NULL,
  `TenSach` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ID_Sach` varchar(11) NOT NULL,
  `Tac_Gia` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `NgayMuon` date NOT NULL,
  `TinhTrang` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
INSERT INTO `MuonTra` (`MaGD`, `TenDG`, `ID_DG`, `SDT`, `TenSach`, `ID_Sach`, `Tac_Gia`, `NgayMuon`, `TinhTrang`) VALUES
(1, 'Nguyễn Văn A', 1, '0123567987', 'Doraemon tập 1', 'DS1', 'Fujiko Fujio', '2018-05-01', 'Đã trả');
...
INSERT INTO `NhaXuatBan` (`stt`, `Ten`) VALUES
(1, ''),
(2, 'Nhà xuất bản Văn Học'),
(3, 'Nhà xuất bản Nhi Đồng'),
(4, 'Chính trị Quốc Gia'),
(5, 'Công an nhân dân'),
(6, 'Đại học Quốc gia Hà Nội'),
(7, 'Đại học Quốc gia Tp.Hồ Chí Minh'),
(8, 'Đại học Sư Phạm'),
(9, 'Nhà xuất bản Hà Nội'),
(10, 'Nhà xuất bản Hải Phòng'),
(11, 'Khoa học và kỹ thuật'),
(12, 'Nhà xuất bản Kim Đồng'),
(13, 'Khoa học xã hội'),
(14, 'Văn hóa Sài Gòn'),
...
CREATE TABLE IF NOT EXISTS `Sach` (
  `ID_Sach` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Ten_Sach` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `The_Loai` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Ten_Tac_Gia` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nha_Xuat_Ban` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nam_Xuat_Ban` int(10) NOT NULL,
  `So_Luong` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `Sach` (`ID_Sach`, `Ten_Sach`, `The_Loai`, `Ten_Tac_Gia`, `Nha_Xuat_Ban`, `Nam_Xuat_Ban`, `So_Luong`, `TinhTrang`, `ID`) VALUES
('DS1', 'Doraemon tập 1', 'Truyện Tranh', 'Fujiko Fujio', 'Nhà xuất bản Nhi Đồng', 2005, '10', 10, 1),
('DS2', 'Conan tập 1', 'Truyện Tranh', 'Gosho Aoyama', 'Nhà xuất bản Nhi Đồng', 2003, '7', 7, 2),
('DS3', 'Nhà giả kim', 'Tâm Lý', 'Paulo Coelho', 'Nhà xuất bản Văn Học', 2003, '8', 8, 3),
('DS4', 'Doraemon tập 2', 'Truyện Tranh', 'Fujiko Fujio', 'Nhà xuất bản Nhi Đồng', 2003, '9', 9, 4),
('DS5', 'Chọc tức vợ yêu chương 1', 'Truyện Ngắn', 'Quẫn Quẫn Hữu Yêu', '', 2008, '8', 8, 5),
('DS6', 'Ô Long Viện Siêu Buồn Cười - Tập 1', 'Truyện Tranh', 'Au, Yao-hsing', '', 2010, '8', 8, 6),
('DS7', 'Ô Long Viện Siêu Buồn Cười - Tập 2', 'Truyện Tranh', 'Au, Yao-hsing', '', 2010, '8', 8, 7),
('DS8', 'Ba Chàng Ngốc', 'Truyện Cười', 'Chetan Bhagat', '', 2005, '7', 7, 8),
('DS9', 'Ai Đó Dõi Theo Em', 'Tiểu Thuyết Nước Ngoài', 'Judith Mcnaught', '', 2003, '8', 8, 9),
('DS10', 'Giang Hồ Ân Cừu Ký tập 1', 'Kiếm Hiệp', 'Giả Kim Dung', '', 2003, '10', 10, 10),
('DS11', 'Conan tập 2', 'Truyện Tranh', 'Gosho Aoyama', 'Nhà xuất bản Nhi Đồng', 2003, '9', 9, 11),
('DS12', 'Giang Hồ Tham Án Truyền Kỳ', 'Truyện Tranh', 'Chu Tiểu Xuyên', '', 2011, '7', 7, 12),
('DS13', 'Phía Sau Nghi Can X chương 1', 'Trinh Thám', 'Higashino Keigo', '', 2011, '8', 8, 13),
('DS14', 'Tuổi Trẻ Đáng Giá Bao Nhiêu', 'Tâm Lý', 'Rosie Nguyễn', 'Nhà xuất bản Kim Đồng', 2008, '10', 10, 14),
('DS15', 'Giang Hồ Ân Cừu Ký tập 2', 'Kiếm Hiệp', 'Giả Kim Dung', '', 2003, '11', 11, 15),
('DS16', 'Giang Hồ Ân Cừu Ký tập 3', 'Kiếm Hiệp', 'Giả Kim Dung', '', 2003, '8', 8, 16),
('DS17', 'Conan tập 3', 'Truyện Tranh', 'Gosho Aoyama', 'Nhà xuất bản Nhi Đồng', 2009, '5', 5, 17),
('DS18', 'Doraemon tập 3', 'Truyện Tranh', 'Fujiko Fujio', 'Nhà xuất bản Nhi Đồng', 2009, '3', 0, 18);
...
INSERT INTO `TheLoai` (`stt`, `Ten`) VALUES
(1, ''),
(2, 'Truyện Tranh'),
(3, 'Kiếm Hiệp'),
(4, 'Tâm Lý'),
...
CREATE TABLE IF NOT EXISTS `VN_quanhuyen` (
...
INSERT INTO `VN_quanhuyen` (`maqh`, `name`, `type`, `matp`) VALUES
...
CREATE TABLE IF NOT EXISTS `VN_tinhthanhpho` (
  `matp` varchar(5) CHARACTER SET utf8 NOT NULL,
  `name` varchar(100) CHARACTER SET utf8 NOT NULL,
  `type` varchar(30) CHARACTER SET utf8 NOT NULL
...
INSERT INTO `VN_tinhthanhpho` (`matp`, `name`, `type`) VALUES
...
--
-- Table structure for table `VN_xaphuongthitran`
--

CREATE TABLE IF NOT EXISTS `VN_xaphuongthitran` (
...
--
-- Dumping data for table `VN_xaphuongthitran`
--

INSERT INTO `VN_xaphuongthitran` (`xaid`, `name`, `type`, `maqh`) VALUES
...
--
-- Indexes for table `VN_xaphuongthitran`
--
...
--
ALTER TABLE `MuonTra`
  MODIFY `MaGD` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
