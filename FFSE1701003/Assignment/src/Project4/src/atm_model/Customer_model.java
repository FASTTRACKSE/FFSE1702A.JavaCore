...
public class Customer_model {
	...
	public ArrayList<Customer_model> getRecords() {
		...
		try {
			...
			while (result.next()) {
				...
				// temp.setThanhpho(result.getInt("thanhpho"));
				// temp.setQuan(result.getInt("quan"));
				// temp.setPhuong(result.getInt("phuong"));
				...
				// temp.setSn_card(result.getString("sn_card"));
				// temp.setSoTKNH(result.getString("soTKNH"));
	...
	public static int addNew(Customer_model ctm) {
		try {
	...
	public static int delete(Customer_model ctm, String maKH) {
		try {
