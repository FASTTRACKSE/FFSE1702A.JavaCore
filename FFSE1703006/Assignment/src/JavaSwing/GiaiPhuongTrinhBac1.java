...
public class GiaiPhuongTrinhBac1 implements ActionListener {
	...
	GiaiPhuongTrinhBac1() {
		JFrame f = new JFrame("Giải phương trình bậc 1 - JunBjn");
		a = new JTextField();
		...
		check_a = new JLabel("Vui lòng nhập số!");
		...
		check_b = new JLabel("Vui lòng nhập số!");
