...
public class TienDien extends KhachHang {
		...
		public void tinhtien() {
			super.xuat() ;
		    System.out.println( "- chỉ số  cũ       : " + getChisocu()+ "\n- chỉ số mới       : " + getChisomoi() + " \n- số ti�?n phải trả : " + getSotienphaitra() +" ngàn đồng." );
		...
		public void nhap() {
			...
			int sotienphaitra =(int) (chisomoi - chisocu ) * 750/1000 ; 
			this.setSotienphaitra(sotienphaitra);
			
		}
		public static void main(String agrs[]) {
			
			TienDien[] listKhachhang = new TienDien[50];
			int controller = 9 ;
			int soluong = 0;
			do 
			{ 
			    ...
			    System.out.print("* số 3 : tính ti�?n điện khách hàng               *\n");
			    System.out.print("*************************************************\n ");
			    System.out.print("\n ch�?n chức năng bạn muốn : ");
				Scanner scanner = new Scanner(System.in);
			    ...
			    }else if(controller == 2 ) 
			    {
			    	for(int i = 0 ; i< soluong ; i++ ) 
			        {
			    		...
			    		listKhachhang[i].xuat1();
			        }
			    }else if(controller == 3) {
			    	for(int i = 0 ; i< soluong ; i++ ) 
			        {
			    		//System.out.println(listKh[i].hoten);
			    		listKhachhang[i].tinhtien();
			        }
