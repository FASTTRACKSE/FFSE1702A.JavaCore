...
public class QLSV {
    ...
    public QLSV(String id, String name, int age, String address, double gpa) {
        super();
        this.id = id;
        this.name = name;
        this.age = age;
    ...
    public static Comparator<QLSV> sortByName = new Comparator<QLSV>() {
        public int compare(QLSV sv1, QLSV sv2) {
            return sv1.name.compareTo(sv2.name);
        }
    };

    public static Comparator<QLSV> sortByGPA = new Comparator<QLSV>() {
        public int compare(QLSV sv1, QLSV sv2) {
