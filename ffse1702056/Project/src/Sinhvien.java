...
public class Sinhvien {
	...
	public void Sinhvien(Sinhvien sinhvien) {
		txtIDsv.setText(sinhvien.getIDsinhvien());
		txtHotensv.setText(sinhvien.getHotensv());
		txtGioitinhsv.setText(sinhvien.getGioitinhsv());
		txtNgaysinhsv.setText(sinhvien.getNgaysinhsv());
		txtDiachisv.setText(sinhvien.getDiachisv());
		txtSdtSv.setText(sinhvien.getHotensv());
		txtBac.setText(sinhvien.getBac());
		txtKhoahoc.setText(sinhvien.getKhoahoc());

		txtIDgv.setText(sinhvien.getIDsinhvien());
		txtTengv.setText(sinhvien.getHotensv());
		txtGioitinhgv.setText(sinhvien.getGioitinhsv());
		txtNgaysinhgv.setText(sinhvien.getNgaysinhsv());
		txtMonday.setText(sinhvien.getMonday());
		txtSdtgv.setText(sinhvien.getSdtgv());
	...
	private String getDiachisv() {
		// TODO Auto-generated method stub
		return null;
	}

	private String getNgaysinhsv() {
		// TODO Auto-generated method stub
		return null;
	}

	private String getGioitinhsv() {
		// TODO Auto-generated method stub
		return null;
	}

	private String getHotensv() {
		// TODO Auto-generated method stub
		return null;
	}

	private String getIDsinhvien() {
		// TODO Auto-generated method stub
		return null;
	}
