...
public class ThongKe extends javax.swing.JFrame {
    ...
    public ThongKe() {
        ...
        try{
            ...
            if(rs1.next()) this.lbTongSach.setText("TÃ¡Â»â€¢ng sÃ¡Â»â€˜ SÃ¡ch : "+Integer.toString(rs1.getInt("sach")));
            if(rs2.next()) this.lbTongKhach.setText("TÃ¡Â»â€¢ng sÃ¡Â»â€˜ khÃ¡ch hÃ ng: " + Integer.toString(rs2.getInt("khachhang")));
            if(rs3.next()) this.lbTongPhieu.setText(" TÃ¡Â»â€¢ng sÃ¡Â»â€˜ phiáº¿u mÆ°á»£n: "+Integer.toString(rs3.getInt("phieumuon")));
            if(rs4.next()) this.lbTongKhachMuon.setText("TÃ¡Â»â€¢ng sÃ¡Â»â€˜ KhÃ¡ch hÃ ng mÆ°á»£n sÃ¡ch: "+Integer.toString(rs4.getInt("khachmuon")));
            if(rs5.next()) this.lbTongPhieuQuaHan.setText("TÃ¡Â»â€¢ng sÃ¡Â»â€˜ Phiáº¿u quÃ¡ háº¡nÂ : "+Integer.toString(rs5.getInt("phieumuon")));
       ...
       /* l=DbUtils.resultSetToNestedList(rs);
        ...
        this.taBaoCao.append("| MÃ£ PM    | MÃ£ KH    | MÃ£ sÃ¡ch | NgÃ y mÆ°á»£n | Háº¡n tráº£      |Tiá»�n cá»�c|NgÃ y tráº£ |\n");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thá»‘ng kÃª");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("Danh sÃ¡ch phiáº¿u mÆ°á»£n quÃ¡ háº¡n");
