...
public class JAdminUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        String tl[]	= {"","Khoa học", "Tiểu thuyết","Ngôn tình", "Kiếm hiệp","Tự truyện"};	
    	JComboBox cb	= new 	JComboBox(tl);
        ...
        tbSach.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Khi hơi thở hóa thinh không" , "P.Kalanithi", "Tự truyện", "alphabook","2 quyển"},
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "Tên sách", "Tác giả", "Thể loại", "Nhà xuất bản", "Tình trạng"
            }
        ));
        ...
        tbMuon.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"P1212", "31/3/2018", "TV1", "S01"},
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "Mã phiếu mượn", "Ngày mượn", "Mã thành viên", "Mã sách"
            }
        ));
        ...
        tbKhach.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"TV1", "Trần Thanh Tùng", "Buôn Ma Thuột", "P1212"},
                {"TV21", "Lê Nguyễn Thanh Tùng", "Quảng Ngãi", ""},
                {"TV32", "Trần Tùng Lâm", "Đà Nẵng", "P0012; P0303"},
                {null, null, null, null}
            },
            new String [] {
                "Mã thành viên", "Tên thành viên", "Thành phố", "Tình hình mượn"
            }
        ));
    ...
    private void btAddSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddSachActionPerformed
        // TODO add your handling code here:
        if (this.txtMaSach.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
        else if(this.txtMaSach.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
        else {
    ...
    private void btEditSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditSachActionPerformed
        ...
        if (this.txtMaSach.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
            ...
            if(sachdata.UpdateSach(s)) {
                JOptionPane.showMessageDialog(null, "Báº¡n Ä‘Ã£ sá»­a thÃ nh cÃ´ng", "ThÃ´ng bÃ¡o", 1);
            }
            else JOptionPane.showMessageDialog(null, "CÃ³ lá»—i xáº£y ra", "ThÃ´ng bÃ¡o", 2);
            this.btLookSach.doClick();
        }
    ...
    private void btDelSachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDelSachActionPerformed
        ...
        if (this.txtMaSach.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
            ...
            if(sachdata.DeleteSach(this.txtMaSach.getText())) {
                JOptionPane.showMessageDialog(null, "Báº¡n Ä‘Ã£ xÃ³a thÃ nh cÃ´ng", "ThÃ´ng bÃ¡o", 1);
            }
            else JOptionPane.showMessageDialog(null, "CÃ³ lá»—i xáº£y ra", "ThÃ´ng bÃ¡o", 2);
            this.btLookSach.doClick();
        }
    ...
    private void btAddKhachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddKhachActionPerformed
        // TODO add your handling code here:
        try{
             if (this.txtMaKhach.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ khÃ¡ch hÃ ng khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
            else if(this.txtMaKhach.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ khÃ¡ch hÃ ng khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
            else {
            ...
            JOptionPane.showMessageDialog(null, "CÃ³ lá»—i xáº£y ra", "ThÃ´ng bÃ¡o", 2);
        }
    ...
    private void btDelKhachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDelKhachActionPerformed
        // TODO add your handling code here:
        if (this.txtMaKhach.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
        else if(this.txtMaKhach.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ sÃ¡ch khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
        else {
    ...
    private void btAddPhieuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddPhieuActionPerformed
        ...
        try{
             if (this.txtMaPhieuMuon.getText().length()==0 ) 
                 JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u mÆ°á»£n khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
            else if(this.txtMaPhieuMuon.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u mÆ°á»£n khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
            else {
    ...
    private void btEditPhieuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditPhieuActionPerformed
        // TODO add your handling code here:
        if (this.txtMaPhieuMuon.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u mÆ°á»£n khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
        else if(this.txtMaPhieuMuon.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u mÆ°á»£n khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
        else {
    ...
    private void btDelPhieuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDelPhieuActionPerformed
        // TODO add your handling code here:
        if (this.txtMaPhieuMuon.getText().length()==0) JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u khÃ´ng thá»ƒ bá»� trá»‘ng", "thÃ´ng bÃ¡o", 2);
        else if(this.txtMaPhieuMuon.getText().length()>10) JOptionPane.showMessageDialog(null, "MÃ£ phiáº¿u khÃ´ng Ä‘Æ°á»£c lá»›n hÆ¡n 10 kÃ½ tá»±", "thÃ´ng bÃ¡o", 2);
        else {
