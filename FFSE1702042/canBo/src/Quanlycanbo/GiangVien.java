...
//			System.out.println("Trinh do cu nhan phu cap la 300");
//			}else if(trinhDo== "thac si") {
//				float phuCap	=	500;
//				this.setPhuCap(phuCap);
//				System.out.println("Trinh do thac si phu cap la 500");
//			}else if(trinhDo== "tien si") {
//				float phuCap	=	1000;
//				this.setPhuCap(phuCap);
//				System.out.println("Trinh do tien si phu cap la 1000");
//			}
