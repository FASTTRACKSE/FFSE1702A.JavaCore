...
--
-- Host: localhost
-- Generation Time: Apr 27, 2018 at 07:38 AM
...
CREATE TABLE IF NOT EXISTS `BanDoc` (
  `id` int(11) NOT NULL,
  `Matv` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `dia_chi_nha` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tinh` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `so_sach_muon` int(11) NOT NULL,
  `password` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
...
INSERT INTO `BanDoc` (`id`, `Matv`, `ho_ten`, `sdt`, `email`, `dia_chi_nha`, `tinh`, `huyen`, `xa`, `so_sach_muon`, `password`) VALUES
(1, 'ffse01', 'win', '123452', 'admin', '13nq', 'Thành phố Hà Nội', 'Quận Ba Đình', 'Phường Phúc Xá', 2, '123123'),
(5, 'ffse17021', 'Trần Lâm Phi Long', '01294067734', 'long0202@gmail.com', 'quang nam', 'Thành phố Hà Nội', 'Quận Ba Đình', 'Phường Phúc Xá', 1, '123'),
(6, 'ffse', 'trần văn bí', '123', 'bi@gmail', '123', 'Thành phố Hà Nội', 'Quận Ba Đình', 'Phường Phúc Xá', 0, '123123');
...
CREATE TABLE IF NOT EXISTS `Phieu_Muon` (
  ...
  `ma_gd` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ngay_muon` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ma_tv` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ma_s` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `Phieu_Muon` (`id_pm`, `ma_gd`, `ngay_muon`, `ma_tv`, `ma_s`, `tinh_trang`, `ngay_tra`) VALUES
(90, '12', '2018-04-27', 'ffse01', 'abc', 'Đã trả', '2018-04-27 03:42:09'),
(91, '13', '2018-04-27', 'ffse01', '123', 'Đã trả', '2018-04-27 03:42:26'),
(92, 'ad', '2018-04-28', 'ffse01', '123', 'Đang mượn', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `QuanLy_Sach`
--

CREATE TABLE IF NOT EXISTS `QuanLy_Sach` (
  `id_sach` int(11) NOT NULL,
  `ma_s` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `ten_s` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tac_gia` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nha_xb` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `nam_xb` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `so_luong_s` int(11) NOT NULL,
  `the_loai` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `tong_sach` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `QuanLy_Sach`
--

INSERT INTO `QuanLy_Sach` (`id_sach`, `ma_s`, `ten_s`, `tac_gia`, `nha_xb`, `nam_xb`, `so_luong_s`, `the_loai`, `tong_sach`) VALUES
(25, 'abc', 'chim sáo mồ côi', 'long', '1999', 'ahihi', 2, 'Phiêu Lưu', 3),
(26, '123', 'chim sáo sang sông', 'quy', 'ahihi', '2000', 1, 'Hài', 3);

-- --------------------------------------------------------

--
-- Table structure for table `The_Loại`
--

CREATE TABLE IF NOT EXISTS `The_Loại` (
  `id` int(11) NOT NULL,
  `the_loai` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `id_tlsach` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `The_Loại`
--

INSERT INTO `The_Loại` (`id`, `the_loai`, `id_tlsach`) VALUES
(1, 'Kiếm hiệp', '1'),
(2, 'Hài', '2'),
(3, 'Phiêu Lưu', '3'),
(4, 'Ma', '4');
...
--
-- Indexes for table `QuanLy_Sach`
--
ALTER TABLE `QuanLy_Sach`
  ADD PRIMARY KEY (`id_sach`);

--
-- Indexes for table `The_Loại`
--
ALTER TABLE `The_Loại`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `Phieu_Muon`
  MODIFY `id_pm` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=94;
--
-- AUTO_INCREMENT for table `QuanLy_Sach`
--
ALTER TABLE `QuanLy_Sach`
  MODIFY `id_sach` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `The_Loại`
--
ALTER TABLE `The_Loại`
