		...
		public void setLoai(String loai) {
		  ...
		  public static void main(String[] args) {
				...
				if(n==1) {
					...
					int tuoi = Integer.parseInt(input2.nextLine());
					sv.setTuoi(tuoi);
					
					System.out.println("diem1");
					int diem1 = Integer.parseInt(input2.nextLine());
					sv.setDiem1(diem1);
					
					System.out.println("diem2");
					int diem2 = Integer.parseInt(input2.nextLine());
					sv.setDiem2(diem2);
				...
				if(n==3) {
			        ...
			        System.out.println("Danh sách sắp xếp theo tên trong bảng chữ cái a - z: ");
			        for (int i = 0; i < SV.size(); i++) {
			        	System.out.println("Ten: " + SV.get(i).getHoten() + "|" + "Tuoi: " + SV.get(i).getTuoi()
								+ "|" + "Diem1: " + SV.get(i).getDiem1() + "|" + "Diem2 "
								+ SV.get(i).getDiem2() + "|" + "TB " + SV.get(i).getTb()+ "|"+ "Loại " + SV.get(i).getLoai());
